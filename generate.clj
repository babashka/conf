  ...
  (head
   [:main
    ...
    [:section#travel
     ...
     [:p "Use " [:a {:href "https://9292ov.nl"} "9292ov.nl"] " or " [:a {:href "https://ns.nl"} "ns.nl"] " to plan your trip. You can tap your contactless bank card or credit card (Mastercard, VISA, VPay, etc.) to enter public transport (train, bus, tram). Use the same card to get out. Much cheaper than a taxi."]
